    ...
    <div>
      <div id="about" className="container">
        ...
        <ul>
          ...
          <li><b>1999 - </b>Parents buy me a Game Boy Color, best friend's Parents get their first PC. Discover my passion for gaming with Pokemon Red & Quake.</li>
          ...
          <li><b>2011 - </b>Professional gaming being in it's infancy years, I transition to a customer support/ QA tester with World Gaming.</li>
          <li><b>2013 - 2018 - </b>Leave World Gaming with a colleague to build a competitor platform to World Gaming, Pro Gaming League (PGL). Worked with a Toronto firm to develop the industry leading gaming Tournament platform, building a userbase of over 300,000. It's during this process that I begin to admire the development process. In 2016, I beging working towards a Computer Science degree part-time at Wilfrid Laurier in Waterloo, Ontario.  In the latter years of PGL, we team up with game developers such as Microsoft's 343 Industries, Electronic Arts, and more, to host large scale in person gaming events. In 2017, PGL is listed on the Toronto Stock Exchange</li>
          <li><b>2019 - </b>Leave PGL, and join a start-up professional gaming organization, Team Reciprocity. I join Team Treehouse and in my spare time, contiunue to learn Python, but begin to transition my focus to Javascript.</li>
          <li><b>2020 - </b>Covid-19 hits, Team Reciprocity is forced to seize operations. No better opportunity to commit to the career change I've slowly been working towards. Daily practice, focusing on Javascript, Node, Express, Postgres, and React. I created this website, as a record of all things that I've created and leared.</li>
        </ul>
